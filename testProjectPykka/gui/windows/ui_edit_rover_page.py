...
class EditRoverPageView(QWidget):
    def __init__(self, parent=None, ui=None):
        ...
        page_view_create = self.ui.page_create_rover.findChild(QFrame, "central_frame_page_create_rover")
        if page_view_create is not None:
            page_view_create.setHidden(True)
        to_create = self.ui.page_create_rover.findChild(QFrame, "central_frame_page_edit_rover")
    ...
    def initialize_gui(self):
        # Central frame
        self.ui.central_frame_page_edit_rover = QFrame(self.ui.page_create_rover)
        ...
        self.ui.page_create_rover_layout.addWidget(self.ui.central_frame_page_edit_rover, 0, Qt.AlignHCenter)
    ...
    def add_exp_bat_grid_layout(self, grid_layout_name, label_name, text_label, error_label_name, line_edit_name,
        ...
        grid_layout = self.edit_generic_layout(grid_layout_name)
        # Add label
        self.ui.exp_bat_edit_label = CustomLabel(parent=self.ui.central_frame_page_edit_rover, name=label_name, text=text_label,
                               width_label=width_label)
        # Add error label
        self.ui.exp_bat_edit_error_label = CustomLabelError(parent=self.ui.central_frame_page_edit_rover, name=error_label_name, text="")
        # Add lineEdit
        self.ui.exp_bat_edit_line_edit = CustomLineEdit(parent=self.ui.central_frame_page_edit_rover, lineEdit_name=line_edit_name,
                                   label_error=self.ui.exp_bat_edit_error_label, line_edit_type=line_edit_type)
    ...
    def add_trans_bat_grid_layout(self, grid_layout_name, label_name, text_label, error_label_name, line_edit_name,
        ...
        grid_layout = self.edit_generic_layout(grid_layout_name)
        # Add label
        self.ui.trans_bat_edit_label = CustomLabel(parent=self.ui.central_frame_page_edit_rover, name=label_name, text=text_label,
                               width_label=width_label)
        # Add error label
        self.ui.trans_bat_edit_error_label = CustomLabelError(parent=self.ui.central_frame_page_edit_rover, name=error_label_name, text="")
        # Add lineEdit
        self.ui.trans_bat_edit_line_edit = CustomLineEdit(parent=self.ui.central_frame_page_edit_rover, lineEdit_name=line_edit_name,
                                   label_error=self.ui.trans_bat_edit_error_label, line_edit_type=line_edit_type)
    ...
    def add_name_grid_layout(self, grid_layout_name, label_name, text_label, error_label_name, line_edit_name,
        ...
        grid_layout = self.edit_generic_layout(grid_layout_name)
        # Add label
        self.ui.name_edit_label = CustomLabel(parent=self.ui.central_frame_page_edit_rover, name=label_name, text=text_label,
                               width_label=width_label)
        # Add error label
        self.ui.name_edit_error_label = CustomLabelError(parent=self.ui.central_frame_page_edit_rover, name=error_label_name, text="")
        # Add lineEdit
        self.ui.name_edit_line_edit = CustomLineEdit(parent=self.ui.central_frame_page_edit_rover, lineEdit_name=line_edit_name,
                                   label_error=self.ui.name_edit_error_label, line_edit_type=line_edit_type)
