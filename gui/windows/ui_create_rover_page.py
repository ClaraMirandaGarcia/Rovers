...
class CreateRoverPageView(QWidget):
    ...
    def initialize_gui(self):
        # Container frame
        self.ui.create_container_frame = QFrame(self.ui.page_create_rover)
        self.ui.create_container_frame.setObjectName(u"create_container_frame")
        self.ui.create_container_frame.setFrameShape(QFrame.StyledPanel)
        self.ui.create_container_frame.setFrameShadow(QFrame.Raised)

        self.ui.create_container_layout = QHBoxLayout(self.ui.create_container_frame)
        self.ui.create_container_layout.setObjectName(u"create_container_layout")
        self.ui.create_container_layout.setAlignment(Qt.AlignTop)

        # Frame return button
        self.ui.frame_return_create = QFrame(self.ui.create_container_frame)
        self.ui.frame_return_create.setObjectName(u"frame_return_create")
        self.ui.frame_return_create.setFrameShape(QFrame.StyledPanel)
        self.ui.frame_return_create.setFrameShadow(QFrame.Raised)

        self.ui.return_create_layout = QVBoxLayout(self.ui.frame_return_create)
        self.ui.return_create_layout.setObjectName(u"return_create_layout")

        # return button
        # Frame return button
        self.ui.return_button_create = CustomReturnButton(self.ui, self.ui.frame_return_create,
                                                          self.ui.page_create_rover, "return_button_create")

        self.ui.return_create_layout.addWidget(self.ui.return_button_create)
        self.ui.create_container_layout.addWidget(self.ui.frame_return_create)
        self.ui.page_create_rover_layout.addWidget(self.ui.create_container_frame)
        ...
        self.ui.central_layout_page_create_rover.setAlignment(Qt.AlignTop)
    ...
    def add_exp_bat_grid_layout(self, grid_layout_name, label_name, text_label, error_label_name, line_edit_name,
        ...
        grid_layout = self.create_generic_layout(grid_layout_name)
        # Add label
        self.ui.exp_bat_create_label = CustomLabel(parent=self.ui.central_frame_page_create_rover, name=label_name,
                                                   text=text_label,
                                                   width_label=width_label)
        # Add error label
        self.ui.exp_bat_create_error_label = CustomLabelError(parent=self.ui.central_frame_page_create_rover,
                                                              name=error_label_name, text="")
        # Add lineEdit
        self.ui.exp_bat_create_line_edit = CustomLineEdit(parent=self.ui.central_frame_page_create_rover,
                                                          lineEdit_name=line_edit_name,
                                                          label_error=self.ui.exp_bat_create_error_label,
                                                          line_edit_type=line_edit_type)
    ...
    def add_trans_bat_grid_layout(self, grid_layout_name, label_name, text_label, error_label_name, line_edit_name,
        ...
        grid_layout = self.create_generic_layout(grid_layout_name)
        # Add label
        self.ui.trans_bat_create_label = CustomLabel(parent=self.ui.central_frame_page_create_rover, name=label_name,
                                                     text=text_label,
                                                     width_label=width_label)
        # Add error label
        self.ui.trans_bat_create_error_label = CustomLabelError(parent=self.ui.central_frame_page_create_rover,
                                                                name=error_label_name, text="")
        # Add lineEdit
        self.ui.trans_bat_create_line_edit = CustomLineEdit(parent=self.ui.central_frame_page_create_rover,
                                                            lineEdit_name=line_edit_name,
                                                            label_error=self.ui.trans_bat_create_error_label,
                                                            line_edit_type=line_edit_type)
    ...
    def add_name_grid_layout(self, grid_layout_name, label_name, text_label, error_label_name, line_edit_name,
        ...
        grid_layout = self.create_generic_layout(grid_layout_name)
        # Add label
        self.ui.name_create_label = CustomLabel(parent=self.ui.central_frame_page_create_rover, name=label_name,
                                                text=text_label,
                                                width_label=width_label)
        # Add error label
        self.ui.name_create_error_label = CustomLabelError(parent=self.ui.central_frame_page_create_rover,
                                                           name=error_label_name, text="")
        # Add lineEdit
        self.ui.name_create_line_edit = CustomLineEdit(parent=self.ui.central_frame_page_create_rover,
                                                       lineEdit_name=line_edit_name,
                                                       label_error=self.ui.name_create_error_label,
                                                       line_edit_type=line_edit_type)
